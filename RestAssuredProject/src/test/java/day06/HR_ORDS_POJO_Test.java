...
public class HR_ORDS_POJO_Test {
    ...
    public void testLocations() {
        //save all street adress to List<String>
        // save all Locations into List<Location>

        Response response = get("/locations").prettyPeek();
        //save all the streest adress to List<String>
        List<String> adressList=response.jsonPath().getList("items.street_address");
        System.out.println("adressList = " + adressList);
...
//        }
    ...
    //    locationsList.forEach(eachLocation-> System.out.println("eachLocation = "+eachLocation));
        ...
        List<Locations> usLocations=response.jsonPath()
                .getList("items.findAll { it.country_id == 'US' } ",Locations.class);
       // System.out.println("usLocations = " + usLocations);
        usLocations.forEach(eachLocation-> System.out.println(usLocations));
