...
public class HR_ORDS_GroovyMagic {
    ...
    public void testEmployees() {
        ...
        //fist id
        System.out.println("First ID " + jp.get("items[0].employee_id"));

        //last id
        System.out.println("Last ID " + jp.get("items[-1].employee_id"));
        ...
        //save all the first_name of the employees with salary more then 15000

        List<String> richPeople = jp.getList("items.findAll{ it.salary>15000 }.first_name");
        System.out.println("richPeople = " + richPeople);

        //Find out all the phone_number is department_id 90
