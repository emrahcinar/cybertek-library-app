...
public class Practice1 {
    ...
    public void test1() {
        ...
        System.out.println("Content-Type length " + response.header("Content-Length"));
    ...
    public void testHello() {
        ...
        assertEquals(200, response.statusCode(), "works!!!");
        ...
        //testing the Content-Type length value is : 17
    ...
    public void testingHelloResponseBody() {
        ...
        //PLEASE DO NOT USE TOSTRING- IT DOESNT GIVE YOU THE CONTENT
        //THATS WHY asSTRING METHOD EXIST
    ...
    public void printingBody() {
      Response response = get("http://54.174.216.245:8000/api/hello");
//
//        //easy way to print response body and return at the same time
