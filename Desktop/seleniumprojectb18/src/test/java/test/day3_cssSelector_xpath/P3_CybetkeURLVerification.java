...
public class P3_CybetkeURLVerification {
    public static void main(String[] args) {
        ...
        emailInput.sendKeys("emrah-c@hotmail.com");

        // int inte 123=driver.findElement(By.id("form_submit"));
