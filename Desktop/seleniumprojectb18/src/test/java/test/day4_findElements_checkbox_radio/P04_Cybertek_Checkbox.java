...
public class P04_Cybertek_Checkbox {
...
// 3.Confirm   checkbox   #2 is SELECTED   by default.
        ...
        if (checkbox2.isSelected()) {
            System.out.println("Checkbox2 is selected by default. Verification PASSED!");
        } else {
            System.out.println("Checkbox2 is not selected by default. Verification FAILED!");
        }
